...
export function FileView({ threadId }: { threadId: string }): JSX.Element {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      <header className={cn('drag-region flex h-13 shrink-0 items-center gap-2.5 border-b pr-3.5 transition-[padding] duration-150 ease-out', sidebarCollapsed ? 'pl-titlebar' : 'pl-3.5')}>
