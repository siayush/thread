...
/**
 * The right panel is a tabbed workspace beside the chat, modelled on t3 code's
 * right panel: an ordered list of surfaces (tabs) plus one active id, scoped
...
/** the panel may take at most 70% of the window, like t3 code's preview panel */
...
interface RightPanelState {
  ...
  resizing: boolean
  /** which thread's panel is maximized (fills everything right of the sidebar), t3-code style */
