        ...
        <main className="isolate flex min-w-0 flex-1 flex-col">
          {activeThreadId ? (
            ...
            <div className="flex min-h-0 flex-1 flex-col bg-background">
              <header className={cn('drag-region flex h-13 items-center gap-1.5 pr-5 transition-[padding] duration-150 ease-out', sidebarCollapsed ? 'pl-[calc(var(--controls-left)+2rem)]' : 'pl-5')}>
